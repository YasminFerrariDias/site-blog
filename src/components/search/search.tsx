  ...
  return (
    <form onSubmit={handleSearch} className="relative group w-full md:max-w-72 md:min-w-0">
      ...
      <input
        ...
        className="w-full h-10 bg-transparent border border-gray-400 pl-9 text-gray-100 rounded-md text-body-sm outline-none transition-all duration-200 focus-within:border-blue-300 focus-within:ring-1 focus-within:ring-blue-300 placeholder:text-gray-300 placeholder:text-body-sm"
      />
